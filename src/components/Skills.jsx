const skills = [
  ...
  { name: "TailwindCSS", level: 85, category: "front-end" },
  { name: "React", level: 85, category: "front-end" },
  { name: "Typescript", level: 70, category: "front-end" },

  //backend
  { name: "Python", level: 60, category: "back-end" },
  { name: "Django", level: 40, category: "back-end" },
  { name: "Node.js", level: 70, category: "back-end" },
  { name: "ExpressJs", level: 80, category: "back-end" },
  { name: "SQL", level: 60, category: "back-end" },
  //Tools
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
          {skills.map((skill, key) => (
            <div
              key={key}
              className="bg-card p-6 rounded-lg shadow-xs card-hover items-center"
            >
              ...
              <div>
                <p className="font-thin italic">{skill.category}</p>
              </div>
            </div>
          ))}
        </div>
